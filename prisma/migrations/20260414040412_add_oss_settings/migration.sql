...
INSERT INTO "new_SiteSettings" ("email", "id", "instagram", "landingAnimMs", "landingBgDesktop", "landingBgMobile", "landingEnabled", "landingStayMs", "linkedin", "location", "siteName", "siteTagline", "updatedAt") SELECT "email", "id", "instagram", "landingAnimMs", "landingBgDesktop", "landingBgMobile", "landingEnabled", "landingStayMs", "linkedin", "location", "siteName", "siteTagline", "updatedAt" FROM "SiteSettings";
